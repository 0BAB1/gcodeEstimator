...
G71U1R0.5 (depth of cut and retract value)
...
G01 X10 (p4)
G03 X5 Z-5 R5 (p5)
N200 G00 X20 Z0 F2000 (se rtirer en avance rapide, on garde F2000 pour que cela reste negligeable dans le temps total.  l'idée est juste d'en tester 2 a la suite)
(FORME DU PROFIL :)
...
(total estimated time : 57 + f2000 seconds (+- 4s en gros sera suffisant pour un test convenable))